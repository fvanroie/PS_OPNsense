...
namespace OPNsense.Nginx {
	public class Http_Server {
		...
		public Nullable<ushort> listen_https_port { get; set; }
		public Nullable<ushort> listen_http_port { get; set; }
		...
		public Http_Server (
			...
			Nullable<ushort> Listen_Https_Port,
			Nullable<ushort> Listen_Http_Port,
			PSObject Locations,
...
namespace OPNsense.Nginx {
	public class Upstream_Server {
		...
		public Nullable<ushort> port { get; set; }
